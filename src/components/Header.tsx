...
export const Header: React.FC = () => {
  ...
  return (
    <>
      ...
      {/* Mobile Menu Overlay */}
      <div 
        className={`absolute inset-0 min-h-dvh bg-black/50 z-60 transition-opacity duration-300 ${
      ...
      <div 
        ref={drawerRef}
        className={`absolute inset-y-0 right-0 min-h-dvh w-64 bg-sage-50 shadow-lg transform md:hidden z-70
